...
**Status:** Phases 0–7 all shipped and green (202 Python tests + Swift package). The planned
...
> and ramble); without it a promoted adapter served garbage. Suite stays green (202 passed, 1
